...
const EditSessionPage = () => {
  ...
  const formik = useFormik({
    initialValues: {
      ...
      sessionOrganizer: sessionData.sessionOrganizer || '',
      sessionDate: sessionData.sessionDate || '',
      sessionStartTime: sessionData.sessionStartTime || '09:00',
      sessionEndTime: sessionData.sessionEndTime || '09:00',
      sessionLocation: sessionData.sessionLocation || 'Online',
